...
\textbf{Verfahren zu Reduzierung der Dimensionalität} nehmen an, dass es eine unterliegende Struktur gibt, welche entdeckt werden kann. Eine Vektor aus einem $n$-dimensionalen Raum wird auf einen $m$-dimensionalen Raum mit $m < n$ abgebildet. Also einfaches Beispiel soll hier ein zweidimensionaler Datensatz dienen, der auf einen eindimensionalen Raum abgebildet wird:  
