...
\textbf{Gradienten} Ein Gradient beschreibt die Änderungen der Intensität eines Bildes in eine Richtung.  Ändert sich die Intensität beispielsweise proportional von Pixel zu Pixel, wird von einem linearen Gradienten gesprochen. In der Bildverarbeitung sind große bzw. plötzliche Änderungen in der Intensität von Bedeutung: Hier handelt es sich potentiell um Ecken oder Kanten, die für weitere Analysen des Bildes verwendet werden können. Da zunächst nur ein Pixel vorliegt, muss senkrecht zum Gradienten untersucht werden, ob ähnliche Veränderungen der Intensität vorliegen. In Abbildung \ref{img:grad} ist links wieder das Bild der Freiheitsstatue dargestellt, rechts die berechneten Gradienten (Laplace Operator).
