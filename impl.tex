...
Die Abkürzung \textit{relu} steht hier für \textit{Rectified Linear Unit (ReLU)}. Die Schichten können über verschiedene Aktivierungsfunktionen miteinander verbunden sein, hier wird aber für alle die \textit{ReLU} benutzt \todo{Grund}.
...
\todo{Etwas erläutern, wie das Modell mit TensorFlow zusammenhängt!}
