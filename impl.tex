...
Zunächst wird eine Übersicht über die Projektstruktur der Bag of Visual Words Implementierung gegeben. Neben der konkreten Klassenstruktur wird auf Abweichungen zum Konzept eingegangen. Dem schließt die Betrachtung des k-means Clustering der Features an. Unterschiede sowie Limitierungen der \textit{global} und \textit{shared memory} Realisierung werden hier anhand des Codes aufgezeigt.
